  ...
  return (
    <div className="space-y-20 pb-20">
      ...
      <section className="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-12">
        {/* Testimonials */}
        <div className="bg-white border border-cream-200 p-8 sm:p-12 rounded-2xl flex flex-col justify-between">
        ...
        <div className="bg-charcoal-700 text-white p-8 sm:p-12 rounded-2xl flex flex-col justify-between">
          <div className="space-y-6">
      ...
      <section className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {blogs.map((blog) => (
            <div key={blog.id} className="bg-white border border-cream-200 rounded-2xl overflow-hidden p-6 sm:p-8 flex flex-col justify-between group">
              <div className="space-y-4">
