    ...
    <div className="space-y-16 pb-20">
      ...
      <section className="relative h-[35vh] flex items-center justify-center bg-ink-600">
        ...
        <div className="container relative z-10 text-center space-y-3">
          ...
          <p className="text-xs font-ui uppercase tracking-widest text-terra-300">How to get the perfect burn and maximize scent throw</p>
      ...
      <section className="container mx-auto px-4 max-w-4xl space-y-12">
        ...
        <div className="text-center max-w-xl mx-auto space-y-2">
          <h2 className="text-display text-2xl sm:text-3xl text-ink-600">The Golden Rules of Candle Care</h2>
          <p className="text-xs text-ink-400 font-body">Soy wax is natural and behaves differently than paraffin. Follow these steps to get a safe, soot-free, and long-lasting burn.</p>
        </div>

        {/* Step List */}
        <div className="space-y-8">
          
          <div className="bg-white border border-sand-200 p-6 sm:p-8 rounded-2xl flex gap-6">
            <div className="text-terra-300 font-serif italic text-3xl sm:text-4xl flex-shrink-0">01.</div>
            <div className="space-y-2">
              <h3 className="font-display text-lg font-semibold text-ink-600">Establish a Burn Memory</h3>
          ...
          <div className="bg-white border border-sand-200 p-6 sm:p-8 rounded-2xl flex gap-6">
            <div className="text-terra-300 font-serif italic text-3xl sm:text-4xl flex-shrink-0">02.</div>
            <div className="space-y-2">
              <h3 className="font-display text-lg font-semibold text-ink-600">Trim the Wick Before Every Burn</h3>
              <p className="text-xs sm:text-sm text-ink-500 leading-relaxed font-body">
          ...
          <div className="bg-white border border-sand-200 p-6 sm:p-8 rounded-2xl flex gap-6">
            <div className="text-terra-300 font-serif italic text-3xl sm:text-4xl flex-shrink-0">03.</div>
            <div className="space-y-2">
              <h3 className="font-display text-lg font-semibold text-ink-600">Limit Burn Time to 4 Hours</h3>
              <p className="text-xs sm:text-sm text-ink-500 leading-relaxed font-body">
          ...
          <div className="bg-white border border-sand-200 p-6 sm:p-8 rounded-2xl flex gap-6">
            <div className="text-terra-300 font-serif italic text-3xl sm:text-4xl flex-shrink-0">04.</div>
            <div className="space-y-2">
              <h3 className="font-display text-lg font-semibold text-ink-600">Practice Candle Safety</h3>
              <ul className="text-xs text-ink-500 space-y-1.5 leading-relaxed font-body list-disc pl-4">
      ...
      {/* Recycle & Reuse Box */}
      <section className="bg-sand-100 border-y border-sand-200 py-12">
        <div className="container mx-auto px-4 max-w-3xl text-center space-y-4">
          <h3 className="font-display text-xl sm:text-2xl text-ink-600">♻️ How to Clean & Reuse Your Jars</h3>
          <p className="text-xs text-ink-500 leading-relaxed font-body max-w-xl mx-auto">
      ...
      <section className="container mx-auto px-4 text-center max-w-xl space-y-6 pt-6">
        <h2 className="text-display text-2xl text-ink-600">Ready to Light Your Space?</h2>
