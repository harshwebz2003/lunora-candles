...
export default function DeliveryPolicyPage() {
  return (
    <div className="container mx-auto px-4 py-16 max-w-3xl space-y-8 font-body text-xs sm:text-sm text-charcoal-500 leading-relaxed">
      <h1 className="text-display text-3xl sm:text-5xl font-light text-charcoal-700 text-center mb-6">Delivery & Return Policies</h1>
      
      <p className="italic text-charcoal-400">Last updated: July 16, 2026</p>
      
      <h2 className="text-display text-xl text-charcoal-700 font-semibold mt-6">1. Island-wide Delivery (Sri Lanka)</h2>
      <p>
      ...
      <h2 className="text-display text-xl text-charcoal-700 font-semibold mt-6">2. Returns and Replacements</h2>
      <p>
      ...
      <p>
        If your candle jar arrives broken or damaged during shipping, please take a photo of the package immediately and send it to our WhatsApp support at <a href="https://wa.me/94769410682" className="text-gold-400 font-bold hover:underline">+94 76 941 0682</a> within 24 hours of delivery. We will gladly send you a free replacement candle.
      </p>

      <h2 className="text-display text-xl text-charcoal-700 font-semibold mt-6">3. Custom Orders</h2>
      <p>
