...
export default function TermsPage() {
  return (
    <div className="container mx-auto px-4 py-16 max-w-3xl space-y-8 font-body text-xs sm:text-sm text-ink-500 leading-relaxed">
      <h1 className="text-display text-3xl sm:text-5xl font-light text-ink-600 text-center mb-6">Terms of Service</h1>
      ...
      <h2 className="text-display text-xl text-ink-600 font-semibold mt-6">1. Handcrafted Product Disclaimer</h2>
      <p>
      ...
      <h2 className="text-display text-xl text-ink-600 font-semibold mt-6">2. Pricing and Payments</h2>
      <p>
      ...
      <h2 className="text-display text-xl text-ink-600 font-semibold mt-6">3. Proper Candle Use & Safety</h2>
      <p>
      ...
      <h2 className="text-display text-xl text-ink-600 font-semibold mt-6">4. Contact Information</h2>
      <p>
        For inquiries regarding our terms, please email us at <a href="mailto:lunoracandles.info@gmail.com" className="text-terra-400 font-bold hover:underline">lunoracandles.info@gmail.com</a>.
      </p>
    </div>
  );
}
